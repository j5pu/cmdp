...
from typing import Any, AnyStr, ParamSpec, TextIO, TypeVar, cast

from .constants import EXECUTABLE, EXECUTABLE_SITE, MACOS, NODEPS_PROJECT_NAME
...
def envsh(
    ...
    updated = {key: value for key, value in environ.items() if os.environ.get(key) != value and
               key not in ["PWD", "SHLVL", "_", "__CF_USER_TEXT_ENCODING", "LC_CTYPE"]}
    if override:
