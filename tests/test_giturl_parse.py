...
VALID_PARSE_URLS = (
    ...
    (
        ...
        (
            "https://gitlab.com/nephila/git-urlparse/blob/master/giturlparse/github.py",
            {
                ...
                "owner": "nephila",
                "repo": "git-urlparse",
                "ownerrepo": "nephila/git-urlparse",
                "name": "git-urlparse",
                "groups": [],
                "path": "master/giturlparse/github.py",
                "path_raw": "/blob/master/giturlparse/github.py",
    ...
    (
        "SSH",
        (
            "git+ssh://git@gitlab.example.com/groupA/projectB.git",
            {
                "host": "gitlab.example.com",
                "resource": "gitlab.example.com",
                "user": "git",
